...
createGroupTable=function(data,classwidth){
  minimumValue=(min(data)%/%10)*10
  MaximumValue=((max(data)%/%10)+1)*10
  ...
  print(paste('the mean =','sum of (fx)/N'))
...
createGroupTable(score,10) # implementing the function.
# Example 2
wages = c(88,82,96,102,104,106,104,24,26,29,86,36,60,23,24,39,48,46,
          ...
          + 83,89,90,94,96,99,102,46) # another data set
createGroupTable(wages,10) #implemmenting the function.
